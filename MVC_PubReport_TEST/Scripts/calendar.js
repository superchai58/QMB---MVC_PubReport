(function(root, factory) {
    ...
    var defaults = {
        ...
        TEMPLATE = [
            ...
            '<a href="javascript:;" data-calendar-display-date class="calendar-display" style=" color:#888;">',
            ...
            '<div class="calendar-hd">',
            '<a href="javascript:;" data-calendar-display-month class="calendar-display" style=" color:#888;">{yyyy}</a>',
            '<div class="calendar-arrow">',
