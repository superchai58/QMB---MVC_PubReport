$(document).ready(function () {
    ...
    $Calendar.calendar({
        ...
        onClose: function (view, date, data) {
            ...
            url = baseUrl + "/Query/IE_InputQty_TestWOGetPU";
            jsonData = { "Date": Date }
            ajaxJsonRequestDerived(url, 'post', jsonData, IE_InputQty_TestWOGetPU, AjaxFailResult);
        }
    });


    function IE_InputQty_TestWOGetPU(data) {
        if (data.result != "OK") {
    ...
    $btnQuery.click(function () {
        ...
        var url = baseUrl + "/Query/IE_InputQty_TestWO_Query";
        jsonData = { "Date": Date, "PU": PU, "Line": Line, "Shift": Shift, "Model": Model, "WO": WO };
        ajaxJsonRequestDerived(url, 'post', jsonData, IE_InputQty_TestWO_Query, AjaxFailResult);
    });
    ...
    function IE_InputQty_TestWO_Query(data) {
        if (data.result != "OK") {
            ErrorMsg(data.result);
        } else {
