...
$(document).ready(function () {
    ...
    $ddFactory.change(function () {
        ...
        var url = baseUrl + "/IE/IE_STD_ManHour_NextMonth_GetPU";
        if (Factory != "") {
    ...
    $ddPU.change(function () {
        ...
        var url = baseUrl + "/IE/IE_STD_ManHour_NextMonth_GetMode";
    ...
    $ddMode.change(function () {
        ...
        var url = baseUrl + "/IE/IE_STD_ManHour_NextMonth_GetLine";
    ...
    $ddLine.change(function () {
        ...
        var url = baseUrl + "/IE/IE_STD_ManHour_NextMonth_GetData";
    ...
    $btnSave.click(function () {
        ...
        var url = baseUrl + "/IE/IE_STD_ManHour_NextMonth_GetSaveData1";
    ...
    $btnUploadExcel.click(function () {
        ...
        var url = baseUrl + "/IE/IE_STD_ManHour_NextMonth_UploadExcel";
    ...
    $btnDelete.click(function () {
        ...
        if (confirm(msg) == true) {
            ...
            var url = baseUrl + "/IE/IE_STD_ManHour_NextMonth_Delete";
    ...
    $btnToExcel.click(function () {
        ...
        $tbResultTable.tableExport({
            type: 'excel',
            escape: 'false',
            fileName: 'IE_STD_ManHour_NextMonth',
            tableName: 'IE_STD_ManHour_NextMonth',
            ignoreColumn: [0],
            worksheetName: ['IE_STD_ManHour_NextMonth']
        })
    });
